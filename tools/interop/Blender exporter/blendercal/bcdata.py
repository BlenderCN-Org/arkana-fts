    ...
    for actionname, action in Blender.Armature.NLA.GetActions().iteritems():
        ...
        for iponame, ipo in name2ipo.iteritems():
            ...
            for curframe in frames:
                ...
                #bcobject.KeyFrame(track, (curframe - 1) / bcconf.ANIMFPS, blenderbone.loc, blenderbone.quat)
                ...
                print(blenderbone, blenderbone.loc, blenderbone.quat)
                print(matrix*bone.local)
                print(matrix)
