...
FTS::Base4x4Matrix::Base4x4Matrix()
    : m(new float[16])
    , im(new float[16])
{
...
String FTS::Base4x4Matrix::toString(unsigned int in_iDecimalPlaces, bool in_bOneLiner) const
{
    if(in_bOneLiner) {
        return "(" + String::nr(m[0], in_iDecimalPlaces) + ", " + String::nr(m[4], in_iDecimalPlaces) + ", " + String::nr(m[8],  in_iDecimalPlaces) + ", " + String::nr(m[12], in_iDecimalPlaces) + "; "
                   + String::nr(m[1], in_iDecimalPlaces) + ", " + String::nr(m[5], in_iDecimalPlaces) + ", " + String::nr(m[9],  in_iDecimalPlaces) + ", " + String::nr(m[13], in_iDecimalPlaces) + "; "
                   + String::nr(m[2], in_iDecimalPlaces) + ", " + String::nr(m[6], in_iDecimalPlaces) + ", " + String::nr(m[10], in_iDecimalPlaces) + ", " + String::nr(m[14], in_iDecimalPlaces) + "; "
                   + String::nr(m[3], in_iDecimalPlaces) + ", " + String::nr(m[7], in_iDecimalPlaces) + ", " + String::nr(m[11], in_iDecimalPlaces) + ", " + String::nr(m[15], in_iDecimalPlaces) + ") "
             + "(" + String::nr(im[0], in_iDecimalPlaces) + ", " + String::nr(im[4], in_iDecimalPlaces) + ", " + String::nr(im[8],  in_iDecimalPlaces) + ", " + String::nr(im[12], in_iDecimalPlaces) + "; "
                   + String::nr(im[1], in_iDecimalPlaces) + ", " + String::nr(im[5], in_iDecimalPlaces) + ", " + String::nr(im[9],  in_iDecimalPlaces) + ", " + String::nr(im[13], in_iDecimalPlaces) + "; "
                   + String::nr(im[2], in_iDecimalPlaces) + ", " + String::nr(im[6], in_iDecimalPlaces) + ", " + String::nr(im[10], in_iDecimalPlaces) + ", " + String::nr(im[14], in_iDecimalPlaces) + "; "
                   + String::nr(im[3], in_iDecimalPlaces) + ", " + String::nr(im[7], in_iDecimalPlaces) + ", " + String::nr(im[11], in_iDecimalPlaces) + ", " + String::nr(im[15], in_iDecimalPlaces) + ") ";
    } else {
        float biggestM = *std::max_element(m, m+16);
        float biggestIM = *std::max_element(im, im+16);
        float smallestM = *std::min_element(m, m+16);
        float smallestIM = *std::min_element(im, im+16);
        size_t lenM = std::max(String::nr((int64_t)biggestM).len(), String::nr((int64_t)smallestM).len());
        size_t lenIM = std::max(String::nr((int64_t)biggestIM).len(), String::nr((int64_t)smallestIM).len());
        unsigned int wM = in_iDecimalPlaces + lenM + 1;
        unsigned int wIM = in_iDecimalPlaces + lenIM + 1;
        return "/" + String::nr(m[0], in_iDecimalPlaces, wM) + " " + String::nr(m[4], in_iDecimalPlaces, wM) + " " + String::nr(m[8],  in_iDecimalPlaces, wM) + " " + String::nr(m[12], in_iDecimalPlaces, wM) + "\\ " "/" + String::nr(im[0], in_iDecimalPlaces, wIM) + " " + String::nr(im[4], in_iDecimalPlaces, wIM) + " " + String::nr(im[8],  in_iDecimalPlaces, wIM) + " " + String::nr(im[12], in_iDecimalPlaces, wIM) + "\\\n"
               "|" + String::nr(m[1], in_iDecimalPlaces, wM) + " " + String::nr(m[5], in_iDecimalPlaces, wM) + " " + String::nr(m[9],  in_iDecimalPlaces, wM) + " " + String::nr(m[13], in_iDecimalPlaces, wM) + "| "  "|" + String::nr(im[1], in_iDecimalPlaces, wIM) + " " + String::nr(im[5], in_iDecimalPlaces, wIM) + " " + String::nr(im[9],  in_iDecimalPlaces, wIM) + " " + String::nr(im[13], in_iDecimalPlaces, wIM) + "|\n"
               "|" + String::nr(m[2], in_iDecimalPlaces, wM) + " " + String::nr(m[6], in_iDecimalPlaces, wM) + " " + String::nr(m[10], in_iDecimalPlaces, wM) + " " + String::nr(m[14], in_iDecimalPlaces, wM) + "| "  "|" + String::nr(im[2], in_iDecimalPlaces, wIM) + " " + String::nr(im[6], in_iDecimalPlaces, wIM) + " " + String::nr(im[10], in_iDecimalPlaces, wIM) + " " + String::nr(im[14], in_iDecimalPlaces, wIM) + "|\n"
              "\\" + String::nr(m[3], in_iDecimalPlaces, wM) + " " + String::nr(m[7], in_iDecimalPlaces, wM) + " " + String::nr(m[11], in_iDecimalPlaces, wM) + " " + String::nr(m[15], in_iDecimalPlaces, wM) + "/ " "\\" + String::nr(im[3], in_iDecimalPlaces, wIM) + " " + String::nr(im[7], in_iDecimalPlaces, wIM) + " " + String::nr(im[11], in_iDecimalPlaces, wIM) + " " + String::nr(im[15], in_iDecimalPlaces, wIM) + "/";
    }
}

FTS::Base4x4Matrix::operator String() const
{
...
float FTS::Base4x4Matrix::operator[](unsigned int idx) const
{
    if(idx > 15)
        throw FTS::NotExistException("Index " + String::nr(idx), "Base4x4Matrix");

    return m[idx];
}

float FTS::Base4x4Matrix::operator()(unsigned int i, unsigned int j) const
{
    if(i > 4 || j > 4 || i == 0 || j == 0)
        throw FTS::NotExistException("Index " + String::nr(i) + "," + String::nr(j), "Base4x4Matrix");
...
FTS::AffineMatrix::AffineMatrix(const AffineMatrix& in_m)
    : Base4x4Matrix()
    , m3(new float[9])
    , im3(new float[9])
{
...
const AffineMatrix& FTS::AffineMatrix::operator=(const AffineMatrix& in_m)
{
    m[0] = in_m.m[0]; m[4] = in_m.m[4]; m[8]  = in_m.m[8];  m[12] = in_m.m[12];
    m[1] = in_m.m[1]; m[5] = in_m.m[5]; m[9]  = in_m.m[9];  m[13] = in_m.m[13];
    m[2] = in_m.m[2]; m[6] = in_m.m[6]; m[10] = in_m.m[10]; m[14] = in_m.m[14];
...
FTS::AffineMatrix::AffineMatrix(AffineMatrix&& in_m)
{
    this->operator=(std::move(in_m));
}

const AffineMatrix& FTS::AffineMatrix::operator=(AffineMatrix&& in_m)
{
    this->m = in_m.m;
    this->im = in_m.im;
    this->m3 = in_m.m3;
...
AffineMatrix FTS::AffineMatrix::translation(float in_fX, float in_fY, float in_fZ)
{
    AffineMatrix m;
    m.m[12] = in_fX;
    m.m[13] = in_fY;
...
AffineMatrix FTS::AffineMatrix::translation(const Vector& in_v)
{
    return AffineMatrix::translation(in_v.x(), in_v.y(), in_v.z());
}

AffineMatrix FTS::AffineMatrix::translation(const AffineMatrix& in_m)
{
    return AffineMatrix::translation(in_m(1,4), in_m(2,4), in_m(3,4));
}

AffineMatrix FTS::AffineMatrix::rotationX(float in_fTheta)
{
    AffineMatrix m;
...
AffineMatrix FTS::AffineMatrix::rotationY(float in_fTheta)
{
    AffineMatrix m;
    float c = cos(in_fTheta);
    float s = sin(in_fTheta);
...
AffineMatrix FTS::AffineMatrix::rotationZ(float in_fTheta)
{
    AffineMatrix m;
    float c = cos(in_fTheta);
    float s = sin(in_fTheta);
...
AffineMatrix FTS::AffineMatrix::rotationQuat(const Quaternion& in_quat)
{
    float s = 0.0f;
...
AffineMatrix FTS::AffineMatrix::scale(float in_fFactor)
{
    return AffineMatrix::scale(in_fFactor, in_fFactor, in_fFactor);
}

AffineMatrix FTS::AffineMatrix::scale(float in_fX, float in_fY, float in_fZ)
{
...
AffineMatrix FTS::AffineMatrix::scale(const Vector& in_v)
{
    return AffineMatrix::scale(in_v.x(), in_v.y(), in_v.z());
}

AffineMatrix FTS::AffineMatrix::ortho2DProjection(float in_fW, float in_fH)
{
...
AffineMatrix FTS::AffineMatrix::inverse() const
{
    AffineMatrix result;
...
AffineMatrix FTS::AffineMatrix::operator *(const AffineMatrix& o) const
{
    AffineMatrix result;
...
void FTS::AffineMatrix::operator *=(const AffineMatrix& o)
{
...
FTS::General4x4Matrix::General4x4Matrix()
    : Base4x4Matrix()
{
}

FTS::General4x4Matrix::General4x4Matrix(const General4x4Matrix& in_m)
    : Base4x4Matrix()
{
    this->operator=(in_m);
}

const General4x4Matrix& FTS::General4x4Matrix::operator=(const General4x4Matrix& in_m)
{
    m[0] = in_m.m[0]; m[4] = in_m.m[4]; m[8]  = in_m.m[8];  m[12] = in_m.m[12];
    m[1] = in_m.m[1]; m[5] = in_m.m[5]; m[9]  = in_m.m[9];  m[13] = in_m.m[13];
    m[2] = in_m.m[2]; m[6] = in_m.m[6]; m[10] = in_m.m[10]; m[14] = in_m.m[14];
...
FTS::General4x4Matrix::General4x4Matrix(General4x4Matrix&& in_m)
{
    this->operator=(std::move(in_m));
}

const General4x4Matrix& FTS::General4x4Matrix::operator=(General4x4Matrix&& in_m)
{
    m = in_m.m;
    im = in_m.im;
...
FTS::General4x4Matrix::General4x4Matrix(const AffineMatrix& in_m)
    : Base4x4Matrix()
{
    this->operator=(in_m);
}

const General4x4Matrix& FTS::General4x4Matrix::operator=(const AffineMatrix& in_m)
{
    m[0] = in_m.m[0]; m[4] = in_m.m[4]; m[8]  = in_m.m[8];  m[12] = in_m.m[12];
    m[1] = in_m.m[1]; m[5] = in_m.m[5]; m[9]  = in_m.m[9];  m[13] = in_m.m[13];
    m[2] = in_m.m[2]; m[6] = in_m.m[6]; m[10] = in_m.m[10]; m[14] = in_m.m[14];
...
FTS::General4x4Matrix::General4x4Matrix(AffineMatrix&& in_m)
{
    this->operator=(std::move(in_m));
}

const General4x4Matrix& FTS::General4x4Matrix::operator=(AffineMatrix&& in_m)
{
    m = in_m.m;
    im = in_m.im;
...
General4x4Matrix FTS::General4x4Matrix::perspectiveProjection(float in_fFoV, float in_fAspectRatio, float in_fNearPlane, float in_fFarPlane)
{
...
General4x4Matrix FTS::General4x4Matrix::inverse() const
{
    General4x4Matrix result;
    result.m[0] = im[0]; result.m[4] = im[4]; result.m[8]  = im[8];  result.m[12] = im[12];
    result.m[1] = im[1]; result.m[5] = im[5]; result.m[9]  = im[9];  result.m[13] = im[13];
...
General4x4Matrix FTS::General4x4Matrix::operator *(const General4x4Matrix& o) const
{
    General4x4Matrix result;
...
void FTS::General4x4Matrix::operator *=(const General4x4Matrix& o)
{
    this->operator=(*this * o);
}
...
File& FTS::operator<<(File& f, const AffineMatrix& m) {
...
File& FTS::operator>>(File& f, AffineMatrix& m) {
    for(unsigned int i = 0 ; i < 16 ; ++i)
        f >> m.m[i];
    for(unsigned int j = 0 ; j < 4 ; ++j)
        for(unsigned int i = 0 ; i < 3 ; ++i)
...
File& FTS::operator<<(File& f, const General4x4Matrix& m) {
    for(unsigned int i = 0 ; i < 16 ; ++i)
        f << m.m[i];
    for(unsigned int i = 0 ; i < 16 ; ++i)
        f << m.im[i];
...
File& FTS::operator>>(File& f, General4x4Matrix& m) {
    for(unsigned int i = 0 ; i < 16 ; ++i)
        f >> m.m[i];
    for(unsigned int i = 0 ; i < 16 ; ++i)
        f >> m.im[i];
