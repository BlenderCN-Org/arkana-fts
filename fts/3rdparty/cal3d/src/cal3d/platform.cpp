...
bool CalPlatform::readBytes(const char* input, void *pBuffer, int length)
{
...
bool CalPlatform::readFloat(const char* input, float& value)
{
  if (input == NULL) return false;

  memcpy( (void*)&value, (const void*)input, 4 );
...
bool CalPlatform::readShort(const char* input, short& value)
{
  if (input == NULL) return false;

  memcpy( (void*)&value, (const void*)input, 2 );
...
bool CalPlatform::readInteger(const char* input, int& value)
{
  if (input == NULL) return false;
...
bool CalPlatform::readString(const char* input, std::string& strValue)
{
  if (input == NULL) return false;

  // get the string length
  int length;
  memcpy( (void*)&length, (const void*)input, 4 );
  ...
  memcpy( (void*)strBuffer, (const char*)input+4, length );
