...
public:
  ...
  int loadCoreAnimation(const void* buffer);
  ...
  int loadCoreMaterial(const void* buffer);
  ...
  int loadCoreMesh(const void* buffer);
  ...
  bool loadCoreSkeleton(const void* buffer);
