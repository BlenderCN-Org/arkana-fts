...
public:
  ...
  static bool readBytes(const char* input, void *pBuffer, int length);
  static bool readFloat(const char* input, float& value);
  static bool readShort(const char* input, short& value);
  static bool readInteger(const char* input, int& value);
  static bool readString(const char* input, std::string& strValue);
