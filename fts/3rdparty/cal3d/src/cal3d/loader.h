...
public:
  ...
  static CalCoreMeshPtr      loadCoreMesh(const std::string& strFilename, CalCoreSkeleton *skel=NULL);
  ...
  static CalCoreMeshPtr      loadCoreMesh(std::istream& inputStream, CalCoreSkeleton *skel=NULL);
  static CalCoreSkeletonPtr  loadCoreSkeleton(std::istream& inputStream);

  static CalCoreAnimationPtr loadCoreAnimation(const void* inputBuffer, CalCoreSkeleton *skel=NULL);
  static CalCoreAnimatedMorph *loadCoreAnimatedMorphFromBuffer(const void* inputBuffer, unsigned int len);
  static CalCoreMaterialPtr  loadCoreMaterial(const void* inputBuffer);
  static CalCoreMeshPtr      loadCoreMesh(const void* inputBuffer, CalCoreSkeleton *skel=NULL);
  static CalCoreSkeletonPtr  loadCoreSkeleton(const void* inputBuffer);
  ...
  static CalCoreMeshPtr      loadCoreMesh(CalDataSource& inputSrc, CalCoreSkeleton *skel=NULL);
  ...
  static CalCoreMeshPtr loadXmlCoreMesh(const std::string& strFilename, const CalCoreSkeleton* skel = 0);
  ...
  static CalCoreMeshPtr loadXmlCoreMesh(const void *, const CalCoreSkeleton* skel = 0);
...
private:
  ...
  static CalCoreSubmesh *loadCoreSubmesh(CalDataSource& dataSrc, int version, CalCoreSkeleton * skel=NULL);
  ...
  static CalCoreMeshPtr loadXmlCoreMesh(cal3d::TiXmlDocument& doc, const CalCoreSkeleton* skel = 0);
