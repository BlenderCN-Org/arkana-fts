...
CalBufferSource::CalBufferSource(const void *inputBuffer)
...
bool CalBufferSource::readBytes(void *pBuffer, int length)
{
   ...
   bool result = CalPlatform::readBytes( ((const char*)mInputBuffer+mOffset), pBuffer, length );
   mOffset += length;
...
bool CalBufferSource::readFloat(float& value)
{
   ...
   bool result = CalPlatform::readFloat( ((const char*)mInputBuffer+mOffset), value );
   mOffset += 4;
...
bool CalBufferSource::readShort(short& value)
{
   ...
   bool result = CalPlatform::readShort( ((const char*)mInputBuffer+mOffset), value );
   mOffset += 2;
...
bool CalBufferSource::readInteger(int& value)
{
   ...
   bool result = CalPlatform::readInteger( ((const char*)mInputBuffer+mOffset), value );
   mOffset += 4;
...
bool CalBufferSource::readString(std::string& strValue)
{
   ...
   bool result = CalPlatform::readString( ((const char*)mInputBuffer+mOffset), strValue );
