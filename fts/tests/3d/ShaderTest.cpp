...
"// This is yet another comment in the included file\n";
    mgr->makeShader("Bla.shadinc", sIncludedFile);
...
"}\n";
    mgr->makeShader("Bla.vert", sMainFile);
...
"}\n";
    ...
    CHECK_EQUAL(sExpected, mgr->getSource("Bla.vert"));
...
TEST_INSUITE(Shaders, CyclicInclude)
{
    ...
    mgr->makeShader("Bla1.shadinc", sIncludedFile1);
    String sIncludedFile2 = "// This is a comment in the second included file\n";
    mgr->makeShader("Bla2.shadinc", sIncludedFile2);
